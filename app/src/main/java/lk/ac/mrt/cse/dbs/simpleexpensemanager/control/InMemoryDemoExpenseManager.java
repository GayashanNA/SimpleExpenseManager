...
/**
 * please note that this class was used for testing and hence not in it's original state.
 */
public class InMemoryDemoExpenseManager extends ExpenseManager {
    ...
    public void setup() {
        ...
        AccountDAO inMemoryAccountDAO = new DBAccountDAO(context);
        setAccountsDAO(inMemoryAccountDAO);

        TransactionDAO inMemoryTransactionDAO = new DBTransactionDAO(context);
