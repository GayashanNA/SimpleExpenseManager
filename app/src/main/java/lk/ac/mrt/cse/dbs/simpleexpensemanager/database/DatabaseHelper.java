...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DBname = "Accounts Database";
    ...
    public DatabaseHelper(@Nullable Context context) {
        ...
        public void onCreate(SQLiteDatabase sqLiteDatabase) {
            String TABLE_CREATE_QUERY_accounts =  "CREATE TABLE "+Table_Name0+" "+
                ...
                +BALANCE+" REAL" +
                ");";
        /* CREATE TABLE Accounts (Account Number INTEGER PRIMARY KEY, Bank_Name TEXT, Account_Holder_Name TEXT,Balance REAL); */
    ...
    public void updateAccount(Account account){
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put(BALANCE,account.getBalance());
        sqLiteDatabase.update(Table_Name0,contentValues,ACCOUNT_NUMBER+"=?"+account.getAccountNo(),null);
        sqLiteDatabase.close();
    }
}
